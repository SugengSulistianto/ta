...
<body class="hold-transition dark-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__wobble" src="{{ url('front') }}/assets/images/logo/logo.png" alt="Medical Booking Store"
                height="60" width="60">
        </div> 
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('#') }}" class="brand-link">
                <img src="{{ url('front') }}/assets/images/logo/logo.png" alt="Medical Booking Store" width="60" height="45">
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="{{ route('storeinfo') }}"
                                class="nav-link">
                                <i class="nav-icon fas fa-tachometer-alt"></i>
                                <p>Store Info </p>
                            </a>
                        </li>
                        <li class="nav-header">MASTER PRODUCTS</li>
                        <li class="nav-item">
