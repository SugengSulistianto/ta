						...
						<div id="keranjang" class="table-responsive">
							<table class="table table-bordered">
								...
								<tr>
                                    ...
                                    <td><input type="text" readonly="readonly" class="form-control" value="<?php echo $pesanan->status; ?>" name="status_pesanan" id="status_pesanan"></td>
                                </tr>
							</table>
								...
								<tbody id="list">
                                    ...
                                    <input type="hidden" name="kode_layanan[]" value="{{ $l->pivot->kode_layanan }}">
                                        <tr>
                                            ...
                                            <td>
                                                <select name="kasir_id" disabled class="form-control" id="">
                                                    @foreach($kasir as $k)
